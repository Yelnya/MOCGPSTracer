 ...
 */
public class LoginVerification extends ActionBarActivity
{
    //VARIABLES
    ...
    {
        Intent intent = new Intent(LoginVerification.this, GPSTracerActivity.class);
        startActivity(intent);
    }

    public void openActivityExportInDatabase(View view)
    {
        Intent intent = new Intent(LoginVerification.this, ExportInDatabase.class);
        startActivity(intent);
    }
